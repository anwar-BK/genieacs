...
echo -e "${GREEN}========== AAAAA  NN   NN NN  WW         WW  AAAAA   RR   RR   =============${NC}" 
echo -e "${GREEN}========= AA   AA NN  NN  NN   WW  WWW  WW  AA   AA  RRRRRRR    ============${NC}"
...
echo -e "${GREEN}=================   Informasi: Whatsapp 0851-5533-2394 =====================${NC}"
echo -e "${GREEN}============================================================================${NC}"
